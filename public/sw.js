...
const CACHE = 'kingtag-v17';
const ASSETS = ['/css/app.css', '/js/app.js', '/js/map.js', '/fonts/rock-salt.woff2', '/fonts/bebas-neue.woff2', '/icons/icon-192.png', '/img/logo.svg', '/manifest.webmanifest'];
